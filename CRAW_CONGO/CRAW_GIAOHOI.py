...
link_head_main = COMMON_URL.List_URL.get("CONGO")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_CONGO/GIAOHOI.xlsx")
...
with open('../DATA_CONGO/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("CONGO"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("CONGO"))
