...
link_head_main = COMMON_URL.List_URL.get("BRAZIL")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_BRAZIL/GIAOHOI.xlsx")
...
with open('../DATA_BRAZIL/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("BRAZIL"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("BRAZIL"))
