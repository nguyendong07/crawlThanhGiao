...
link_head_main = COMMON_URL.List_URL.get("AMERICA")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_AMERICA/GIAOHOI.xlsx")
    ...
    try:
        for child in children:
            if child.find("a"):
                ...
                DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("AMERICA"))
                print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("AMERICA"))
