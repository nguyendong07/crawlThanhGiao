...
link_head_main = COMMON_URL.List_URL.get("SPAIN")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_SPAIN/GIAOHOI.xlsx")
    ...
    for child in children:
        try:
            if child.find("a"):
                ...
                DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("SPAIN"))
                print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("SPAIN"))
