...
link_head_main = COMMON_URL.List_URL.get("PHILIPINE")
...
r = session.get(link_head_main)
r.encoding = r.apparent_encoding
soup = BeautifulSoup(r.text, 'html.parser')
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_PHILIPINE/GIAOHOI.xlsx")
...
with open('../DATA_PHILIPINE/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("PHILIPINE"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("PHILIPINE"))
