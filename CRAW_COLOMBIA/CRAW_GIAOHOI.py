...
link_head_main = COMMON_URL.List_URL.get("COLOMBIA")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_COLOMBIA/GIAOHOI.xlsx")
...
with open('../DATA_COLOMBIA/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("COLOMBIA"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("COLOMBIA"))
