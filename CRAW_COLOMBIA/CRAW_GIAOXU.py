...
workbook = xlsxwriter.Workbook("../DATA_COLOMBIA/GIAOXU.xlsx")
...
with open('../DATA_COLOMBIA/html.txt', encoding="utf8") as f:
    lines = f.read()
            ...
            if len(church_tag) >= 2:
                ...
                for church in list_church:
                    ...
                    if div_thumb:
                        ...
                        DOWNLOAD_IMAGE.download(Link_Thumb,COMMON_URL.LIST_IMAGES_GIAOXU.get("COLOMBIA"))
