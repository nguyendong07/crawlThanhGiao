...
workbook_giaoxu = xlsxwriter.Workbook("Brasil_giaoxu.xlsx")
worksheet_giaoxu = workbook_giaoxu.add_worksheet("data")


# url = 'http://www.gcatholic.org/dioceses/country/BR-type.htm#metr'
# r = requests.get(url)
...
with open('./DATA_BRAZIL/html.txt', encoding="utf8") as f:
    lines = f.read()
    ...
    for child in children:
        try:
                ...
                for church in list_church:
                    ...
                    for att_detail in list_att_p:
                        ...
                        if "Basilica Decree" in str(att_detail.findChildren("span", {"class": "label"})):
                            BasilicaDecree = att_detail.contents[1]

                        if "Region" in str(att_detail.findChildren("span", {"class": "label"})):
                            Region = att_detail.contents[1]
            ...
            worksheet_giaoxu.write(0, 0, "Jurisdiction")
            worksheet_giaoxu.write(0, 1, "Served_By")
            worksheet_giaoxu.write(0, 2, "Type")
            worksheet_giaoxu.write(0, 3, "BasilicaDecree")
            worksheet_giaoxu.write(0, 4, "Link_Thumb")
            worksheet_giaoxu.write(0, 5, "Rite")
            worksheet_giaoxu.write(0, 6, "Lists")
            worksheet_giaoxu.write(0, 7, "History")
            worksheet_giaoxu.write(0, 8, "Patron")
            worksheet_giaoxu.write(0, 9, "Location")
            worksheet_giaoxu.write(0, 10, "Address")
            worksheet_giaoxu.write(0, 11, "Country")
            worksheet_giaoxu.write(0, 12, "Telephone")
            worksheet_giaoxu.write(0, 13, "Website")
            worksheet_giaoxu.write(0, 14, "GCatholicChurchID")
            worksheet_giaoxu.write(0, 15, "MetropolitanArchbishop")
            worksheet_giaoxu.write(0, 16, "Name")
            worksheet_giaoxu.write(0, 17, "Region")
            worksheet_giaoxu.write(0, 18, "Deanary")

            for index, entry in enumerate(arr):
                worksheet_giaoxu.write(index + 1, 0, entry["Jurisdiction"])
                worksheet_giaoxu.write(index + 1, 1, entry["Served_By"])
                worksheet_giaoxu.write(index + 1, 2, entry["Type"])
                worksheet_giaoxu.write(index + 1, 3, entry["BasilicaDecree"])
                worksheet_giaoxu.write(index + 1, 4, entry["Link_Thumb"])
                worksheet_giaoxu.write(index + 1, 5, entry["Rite"])
                worksheet_giaoxu.write(index + 1, 6, entry["Lists"])
                worksheet_giaoxu.write(index + 1, 7, entry["History"])
                worksheet_giaoxu.write(index + 1, 8, entry["Patron"])
                worksheet_giaoxu.write(index + 1, 9, entry["Location"])
                worksheet_giaoxu.write(index + 1, 10, entry["Address"])
                worksheet_giaoxu.write(index + 1, 11, entry["Country"])
                worksheet_giaoxu.write(index + 1, 12, entry["Telephone"])
                worksheet_giaoxu.write(index + 1, 13, entry["Website"])
                worksheet_giaoxu.write(index + 1, 14, entry["GCatholicChurchID"])
                worksheet_giaoxu.write(index + 1, 15, entry["MetropolitanArchbishop"])
                worksheet_giaoxu.write(index + 1, 16, entry["Name_Church"])
                worksheet_giaoxu.write(index + 1, 17, entry["Region"])
                worksheet_giaoxu.write(index + 1, 18, entry["Deanery"])


            workbook_giaoxu.close()
            print(
...
for index, entry in enumerate(arr):
    ...
    worksheet_giaoxu.write(index + 1, 14, entry["GCatholicChurchID"])
    worksheet_giaoxu.write(index + 1, 15, entry["MetropolitanArchbishop"])
    worksheet_giaoxu.write(index + 1, 16, entry["Name"])
    worksheet_giaoxu.write(index + 1, 17, entry["Region"])
    worksheet_giaoxu.write(index + 1, 18, entry["Deanery"])
workbook_giaoxu.close()
