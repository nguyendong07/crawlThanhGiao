...
workbook = xlsxwriter.Workbook("../DATA_MEXICO/GIAOXU.xlsx")
...
with open('../DATA_MEXICO/html.txt', encoding="utf8") as f:
    lines = f.read()
            ...
            if child.find("a"):
                ...
                if len(church_tag) >= 2:
                    ...
                    for church in list_church:
                        ...
                        # link_church_deltail = "http://www.gcatholic.org/churches/MEXICO/78833.htm"
                        ...
                        if div_thumb:
                            ...
                            DOWNLOAD_IMAGE.download(Link_Thumb,COMMON_URL.LIST_IMAGES_GIAOXU.get("MEXICO"))
