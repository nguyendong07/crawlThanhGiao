...
link_head_main = COMMON_URL.List_URL.get("MEXICO")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_MEXICO/GIAOHOI.xlsx")
...
with open('../DATA_MEXICO/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("MEXICO"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("MEXICO"))
