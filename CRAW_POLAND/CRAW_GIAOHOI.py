...
link_head_main = COMMON_URL.List_URL.get("POLAND")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_POLAND/GIAOHOI.xlsx")
worksheet = workbook.add_worksheet("data")

with open('../DATA_POLAND/html.txt', encoding="utf8") as f:
    lines = f.read()
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("POLAND"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("POLAND"))
