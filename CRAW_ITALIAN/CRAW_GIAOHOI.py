...
link_head_main = COMMON_URL.List_URL.get("ITALIAN")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_ITALIAN/GIAOHOI.xlsx")
...
with open('../DATA_ITALIAN/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("ITALIAN"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("ITALIAN"))
