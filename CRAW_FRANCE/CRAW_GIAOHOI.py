...
link_head_main = COMMON_URL.List_URL.get("FRANCE")
...
print(soup.prettify())
workbook = xlsxwriter.Workbook("../DATA_FRANCE/GIAOHOI.xlsx")
...
with open('../DATA_FRANCE/html.txt', encoding="utf8") as f:
    ...
    for child in children:
        ...
        DOWNLOAD_IMAGE.download(image, COMMON_URL.LIST_IMAGE_GIAOHOI.get("FRANCE"))
        print(COMMON_URL.LIST_IMAGE_GIAOHOI.get("FRANCE"))
